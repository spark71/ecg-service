...
if __name__ == '__main__':
    datafolder = r'C:\Users\redmi\PycharmProjects\ptbxl_models\data\ptbxl'
    task = 'superdiagnostic'
    outputfolder = r'C:\Users\redmi\PycharmProjects\ptbxl_models\output'
    print(1)
    d = load_dataset(datafolder, task, outputfolder)
    print(d)